...
class MainViewModel : ViewModel() {
    ...
    /**
     * Si el usuario deselecciona una opcion, entonces la eliminamos de la lista "secondAnswer"
     */
     ...
     * ordenado y sin repetir opciones
     * thirdAnswer.distinct() crea una nueva colección que contiene solo los elementos únicos de
     *  thirdAnswer, eliminando duplicados.
     */
